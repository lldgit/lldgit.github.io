...
'<h3>Tickets from 25 Euro p.p. </h3>'+
'<ul>'+
'<li class=\"lpo_bigs\"> '+
'<ul class=\"lpo_bigs_second lpo_li\">'+
'<li class=\"secondchild\" style=\"width: 50%;\">Adult</li>'+
'<li class=\"secondchild\" style=\"width: 50%;\">Children (3-11)</li>'+
'</ul>'+
'<ul class=\"lpo_bigs_second lpo_li\">'+
'<li class=\"secondchild\" style=\"width: 50%;\"><span><small>from</small>' + preis_tageskarte_erwachsener_ab + ' €</span></li>'+
'<li class=\"secondchild\" style=\"width: 50%;\"><span><small>from</small>' + preis_tageskarte_kind_ab  + ' €</span></li>'+
'</ul>'+
'<ul class=\"lpo_bigs_second lpo_li\">'+
'<li class=\"secondchild\" style=\"width: 50%;\">'+
'<div style=\"margin-top: -14px;\"><a class=\"lpo_button lpo_white lpo_fr\" style=\"position:absolute; margin-top:6px; margin-left:40px; height:14px; line-height:14px;\" id=\"lpolink1\" href=\"' + lpolink1 + ' \">Book tickets now</a></div>'+
'</li>'+
'<li class=\"secondchild\" style=\"width: 50%;\">'+
...
'</ul>'+
'<ul class=\"lpo_bigs_second lpo_li\">'+
'<li class=\"secondchild\" style=\"width: 50%;\">Family 4 pers.</li>'+
'<li class=\"secondchild\" style=\"width: 50%;\">Family 5 pers.</li>'+
'</ul>'+
'<ul class=\"lpo_bigs_second lpo_li\">'+
...
'<li class=\"secondchild\" style=\"width: 50%;\">'+
'<div style=\"margin-top: -14px;\"><a class=\"lpo_button lpo_white lpo_fr\" id=\"lpolink3\" href=\"' + lpolink3 + '\">book now</a></div>'+
'</li>'+
'<li class=\"secondchild\" style=\"width: 50%;\">'+
'<div style=\"margin-top: -14px;\"><a class=\"lpo_button lpo_white lpo_fr\" id=\"lpolink4\" href=\"' + lpolink4 + '\">book now</a></div>'+
'</li>'+
'</ul>'+
'</li>'+
'</ul>'+
