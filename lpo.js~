...
'<div style=\"margin-top: -14px;\"><a class=\"lpo_button lpo_white lpo_fr\" style=\"position:absolute; margin-left:40px; height:20px;\" id=\"lpolink1\" href=\"' + lpolink1 + ' \">Tickets jetzt sichern</a></div>'+
'</li>'+
'<li class=\"secondchild\" style=\"width: 50%;\">'+
