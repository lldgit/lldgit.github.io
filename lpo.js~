...
'</ul>'+
'<ul class=\"lpo_bigs_second lpo_li\">'+
'<li class=\"secondchild\" style=\"width: 50%;\"><span><small></small>' + preis_familienkarte_4personen_ab + ' € <span style-size="10px">p.P.</span></span></li>'+
'<li class=\"secondchild\" style=\"width: 50%;\"><span><small></small>' + preis_familienkarte_5personen_ab + ' € <span style-size="10px">p.P.</span></span></li>'+
'</ul>'+
