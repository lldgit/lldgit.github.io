...
if($.cookie('lldbig2') === undefined || $.cookie('lldbig2') === null) {
	...
	if(anzahl < 45 && $.cookie('keinlayer')!="111") {
	
	
	$('#sidebar').delay(600).animate({ marginTop: '120px'}, 1000);
	$('#maincontent').delay(600).animate({ marginTop: '120px'}, 1000);
	...
	$( "#funbox" ).delay(600).replaceWith(rumble);
	$('#himage').delay(600).animate({ opacity: 1}, 1500);
