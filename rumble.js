...
if($.cookie('lldbig2') === undefined || $.cookie('lldbig2') === null) {
	...
	$('#sidebar').animate({ marginTop: '120px'}, 1000).delay(600);
	$('#maincontent').animate({ marginTop: '120px'}, 1000).delay(600);
	...
	$( "#funbox" )replaceWith(rumble).delay(600);
	$('#himage')animate({ opacity: 1}, 1500).delay(600);
