...
alert(anzahl);
	...
	var rumble="<div id=\"funbox\"><a href=\"\" style=\"position:absolute; margin-top:90px; border:none; border-radius:20px; padding:3px; margin-left:65px; z-index:100; font-weight:bold; font-size:20px; background:white;\" >x<\/a></div><img src=\"http://lldgit.github.io/bigger.png\" id=\"himage\" style=\"position:absolute; margin-top:150px; opacity:0; width:880px; \">";
